        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> Update Album</h3>
                <div class="mt ">
                    <div class="col-lg-12">
                        <?php
        ...
        ?>
                        <form method="post" action="">
                            <input type="hidden" name="id" id="id" value="<?php if (isset($album_info['AlbumID'])) {
                                                                                echo $album_info['AlbumID'];
                                                                            } ?>">

                            <div class="form-group">
                                <label for="album_Name">Album Name:</label>
                                <input type="text" value="<?php if (isset($album_info['AlbumName'])) {
                                                                echo $album_info['AlbumName'];
                                                            } ?>" class="form-control" name="album_Name" id="album_Name" required maxlength="50">
                            </div>
                            <div class="form-group">
                                <label for="singer">Singer:</label>
                                <input type="text" value="<?php if (isset($album_info['Singer'])) {
                                                                echo $album_info['Singer'];
                                                            } ?>" class="form-control" name="singer" id="singer" required maxlength="50">
                            </div>
                            ...
                            <input type="submit" class="button button-green" name="update_album" value="Update" />
                        </form>
                    </div>
                </div>
